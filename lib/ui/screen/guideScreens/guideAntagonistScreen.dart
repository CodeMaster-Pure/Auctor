...
class GuideAntagonistScreen extends StatefulWidget {
	@override
	GuideAntagonistScreenState createState() => GuideAntagonistScreenState();
}

class GuideAntagonistScreenState extends State<GuideAntagonistScreen> {
...
//		childDirected: false,
	...
	loadInformation() {
		setState(() {
			...
			titleLists.addAll([
				S.of(context).antagonist_guide_array_titles_0,
				S.of(context).antagonist_guide_array_titles_1,
				S.of(context).antagonist_guide_array_titles_2,
				S.of(context).antagonist_guide_array_titles_3,
			]);

			descriptionLists.addAll([
				S.of(context).antagonist_guide_array_desc_0,
				S.of(context).antagonist_guide_array_desc_1,
				S.of(context).antagonist_guide_array_desc_2,
				S.of(context).antagonist_guide_array_desc_3,
			]);
		});
	}
	...
	Widget build(BuildContext context) {
		return Scaffold(
			...
			appBar: AppBar(
				title: Text(S.of(context).antagonist_guide_title),
			),
			body: SingleChildScrollView(
				...
				child: Column(
					...
					children: <Widget>[
						Text(S.of(context).antagonist_guide_title, style: TextStyle(color: ColorConstants.headline, fontSize: 24, fontFamily: 'roboto_lightitalic' ),),
						buildItem(context)
					],
				),
			)
