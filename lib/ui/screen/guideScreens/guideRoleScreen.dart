...
class GuideRoleScreen extends StatefulWidget {
	@override
	GuideRoleScreenState createState() => GuideRoleScreenState();
}

class GuideRoleScreenState extends State<GuideRoleScreen> {
...
//		childDirected: false,
	...
	loadInformation() {
		setState(() {
			...
			titleLists.addAll([
				S.of(context).char_guide_types_titles_0,
				S.of(context).char_guide_types_titles_1,
				S.of(context).char_guide_types_titles_2,
				S.of(context).char_guide_types_titles_3,
				S.of(context).char_guide_types_titles_4,
				S.of(context).char_guide_types_titles_5,
				S.of(context).char_guide_types_titles_6,
				S.of(context).char_guide_types_titles_7,
				S.of(context).char_guide_types_titles_8,
				S.of(context).char_guide_types_titles_9,
				S.of(context).char_guide_types_titles_10
			]);

			descriptionLists.addAll([
				S.of(context).char_guide_types_desc_0,
				S.of(context).char_guide_types_desc_1,
				S.of(context).char_guide_types_desc_2,
				S.of(context).char_guide_types_desc_3,
				S.of(context).char_guide_types_desc_4,
				S.of(context).char_guide_types_desc_5,
				S.of(context).char_guide_types_desc_6,
				S.of(context).char_guide_types_desc_7,
				S.of(context).char_guide_types_desc_8,
				S.of(context).char_guide_types_desc_9,
				S.of(context).char_guide_types_desc_10,
			]);
		});
	}
	...
	Widget build(BuildContext context) {
		return Scaffold(
			...
			appBar: AppBar(
				title: Text(S.of(context).roles_desc),
			),
			body: SingleChildScrollView(
				...
				child: Column(
					...
					children: <Widget>[
						Text(S.of(context).roles_title, style: TextStyle(color: ColorConstants.headline, fontSize: 24, fontFamily: 'roboto_lightitalic' ),),
						buildItem(context)
					],
				),
			)
