...
class EditCharacterScreen extends StatefulWidget {
	EditCharacterScreen({Key key}) : super(key: key);

	@override
	EditCharacterScreenState createState() => EditCharacterScreenState();
}

class EditCharacterScreenState extends State<EditCharacterScreen> {

	EditCharacterScreenState();
...
//		Future.delayed(Duration.zero, this.checkTutorial);
	...
	setCharacterInformation(){
		nameCtrl.text = Common.currentCharacter.name;
		ageCtrl.text = Common.currentCharacter.age;
		heightCtrl.text = Common.currentCharacter.height;
		hairCtrl.text = Common.currentCharacter.hairColor;
		eyeCtrl.text= Common.currentCharacter.eyeColor;
		bodyCtrl.text = Common.currentCharacter.bodyBuild;
		professionCtrl.text = Common.currentCharacter.profession;
		placeOfBirthController.text = Common.currentCharacter.placeBirth;
		phraseCtrl.text = Common.currentCharacter.phrase;
		trait1Ctrl.text = Common.currentCharacter.trait1;
		trait1Ctr2.text = Common.currentCharacter.trait2;
		trait1Ctr3.text = Common.currentCharacter.trait3;
		momnetCtrl.text = Common.currentCharacter.defmoment;
		wantCtrl.text = Common.currentCharacter.desire;
		needCtrl.text = Common.currentCharacter.need;
		noteCtrl.text = Common.currentCharacter.note;
		birthController.text = Common.currentCharacter.birthdate;
		imgString = Common.currentCharacter.image;
	...
	onSave(BuildContext context) {
		if (nameCtrl.text == "") { Helper.showErrorToast(S.of(context).projects_empty); return; }

		Character character = new Character(
			id: Common.currentCharacter.id,
			name: nameCtrl.text,
			age: ageCtrl.text,
		...
		DatabaseHelper().updateCharacter(character).then((result){
			if (result == 1)
				Fluttertoast.showToast(msg: 'Updated Character!');
			else {
	...
	onRandom(BuildContext context) {
		...
		print('soppy bio array size is :' + bio.length.toString());
		nameCtrl.text = bio[0];
		ageCtrl.text = bio[2];
		...
		placeOfBirthController.text = bio[1];
	...
	Widget build(BuildContext context) {
		return Scaffold(
			...
			appBar: AppBar(
				title: Text(S.of(context).character_update),
				actions: <Widget>[
					IconButton(
				...
				children: [
					...
					TextField(
						decoration: InputDecoration(
							...
							labelText: S.of(context).character_add_name,
						),
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_age,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_height,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_haircolor,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_eyecolor,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_bodybuild,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_profession,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_placebirth,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).birthdate_add_text,
		...
		return (Container(
			...
			child: Column(
				...
				children: [
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_phrase,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_trait,
		...
		return (Container(
			...
			child: Column(
				...
				children: [
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_defmoment,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_desire,
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_add_need,
		...
		return (Container(
			...
			child: Column(
				...
				children: [
					...
					TextField(
						decoration: InputDecoration(
							labelText: S.of(context).character_notes_tv,
	...
	onDelete() {
		DatabaseHelper().deleteCharacaterByid(Common.currentCharacter.id).then((result){
			if (result == 1)
				Fluttertoast.showToast(msg: 'Deleted character');
			else
